...
def evaluate_ellipse_fit(image_filename, fit_ellipse, csv_filepath='tests/ground_truths_develop.csv'):
    """
...
def __draw_ellipse(ellipse, image_shape):
    ...
    cv2.ellipse(ellipse_image, center, axes, angle, 0, 360, 150, 1)
    cv2.ellipse(ellipse_image, center, axes, angle, 0, 360, 150, cv2.FILLED)
